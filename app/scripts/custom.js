...
var base_src = 'app/data/bamdata_amazon_links.xml';
var upload_src = '';
var dataset_dictionary = {
  "Araport 11 RNA-seq data": 'app/data/bamdata_amazon_links.xml',
  "Developmental transcriptome - Klepikova et al": 'app/data/bamdata_Developmental_transcriptome.xml'
};
...
function variants_radio_options(status) {
	...
	url: 'https://api.araport.org/community/v0.3/asher-live/efp-seq_browser_adama_v0.3/access/get_gene_structures.cgi?locus=' + locus,
    dataType: 'json',
...
var rnaseq_image_url = "https://api.araport.org/community/v0.3/asher-live/efp-seq_browser_adama_v0.3/access/webservice.cgi";
var match_drive = "";
...
function populate_table(status) {
  ...
  var filtersConfig = {
    base_path: 'app/scripts/tablefilter/',
...
function getGFF(locusID) {
  ...
  $.ajax({
	...
	url: 'https://api.araport.org/community/v0.3/araport/araport11_gene_structure_by_locus_v1.1/search?locus=' + locus,
